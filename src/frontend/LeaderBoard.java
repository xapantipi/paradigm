...
public class LeaderBoard extends JPanel {
	...
	private void setupButtons() {
		...
		easy_b.addMouseListener(new HoverAdapter(() -> selectedMode != BoardMode.EASY, easy_h, easy_n, easy_b));
		inter_b.addMouseListener(new HoverAdapter(() -> selectedMode != BoardMode.MEDIUM, inter_h, inter_n, inter_b));
		hard_b.addMouseListener(new HoverAdapter(() -> selectedMode != BoardMode.HARD, hard_h, hard_n, hard_b));

		easy_b.addActionListener(e -> selectMode(BoardMode.EASY));
		inter_b.addActionListener(e -> selectMode(BoardMode.MEDIUM));
		hard_b.addActionListener(e -> selectMode(BoardMode.HARD));
	...
	private void refreshLeaderboard() {
		List<Player> players = leaderboard.getTopPlayers();
		boardTitle.setText("TOP RECRUITS (" + selectedMode.label + ")");
